...
<head>
	...
	if (empty($og_image_url)) {
		...
		$og_image_url = 'https://www.feuerwehr-aurachhoehe.de/wp-content/uploads/2016/08/apple-touch-icon-180x180.png';
	}
	?>
	...
	wp_enqueue_style('main', get_template_directory_uri() . '/style.css', array(), '3.2.3');
	wp_enqueue_script('materialize-js', get_template_directory_uri() . '/js/materialize.min.js', array(), '1.1.0');
	wp_enqueue_script('main', get_template_directory_uri() . '/js/main.js', array(), '3.2.3');
	?>
	<?php wp_head(); ?>
</head>
